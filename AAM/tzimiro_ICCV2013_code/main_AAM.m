...
for ii = 1:num_of_scales
    ...
    %AAM.texture{ii}.max_m = 300;
end

% Create the AAM
if flag_train
    AAM = train_AAM(where, folder, what, AAM, 811);
...
for gg = 1:224
    ...
    total_error = total_error + pt_pt_err;
end
mean_error = total_error / 224
